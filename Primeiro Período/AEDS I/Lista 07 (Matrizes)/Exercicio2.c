#include<stdio.h>
#include<stdlib.h>
/*Criar um algoritmo que leia os elementos de uma matriz inteira 10 x 10 e escreva todos os
...
int main (void){
    ...
    printf("A matriz sem os numeros da diagonal principal corresponde a:\n\n");
    for (int linha=0;linha<10;linha++){
        for(int coluna=0;coluna<10;coluna++){
           if (linha!=coluna){
               printf("%i ", matriz[linha][coluna]);
