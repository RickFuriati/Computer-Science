...
class heapsortJava {
    ...
    static class Lista {
        ...
        public void heapSort() {
         ...
         public void construir(int tamHeap){
            for(int i = tamHeap; i > 1 && array[i].getGenero().compareTo(array[i/2].getGenero()) > array[i/2].getGenero().compareTo(array[i].getGenero()); i /= 2){
               swap(i, i/2);
    ...
    public static void main(String[] args) throws Exception{
        ...
        listaFilmes.mostrar();
        Arq.openWrite("752959_heapsort.txt");
