...
class quicksortJava {
    ...
    static class Lista {
        ...
        private void quicksort(int esq, int dir) {
            ...
            while (i <= j) {
                comparacoes++;
                while (array[i].getSituacao().compareTo(pivo.getSituacao()) < pivo.getSituacao().compareTo(array[i].getSituacao())){
                    comparacoes++;
                    i++;
                }

                while (array[j].getSituacao().compareTo(pivo.getSituacao()) > pivo.getSituacao().compareTo(array[i].getSituacao())){
                    comparacoes++;
                    j--;
        ...
        private void quicksortDesempate(int esq, int dir) {
            ...
            while (i <= j) {
                comparacoes++;
                while (array[i].getNome().compareTo(pivo.getNome()) < pivo.getNome().compareTo(array[i].getNome())){
                    comparacoes++;
                    i++;
                    
                }
    
                while (array[j].getNome().compareTo(pivo.getNome()) > pivo.getNome().compareTo(array[i].getNome())){
                    comparacoes++;
                    j--;
    ...
    public static void main(String[] args) throws Exception{
        ...
        listaFilmes.mostrar();
        Arq.openWrite("752959_quicksort.txt");
