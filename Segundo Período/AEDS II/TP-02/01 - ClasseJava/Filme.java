...
class Filme{
    ...
    static SimpleDateFormat default_dateFormat = new SimpleDateFormat("dd/MM/yyyy"); // Formatação padrão da data como dia/mes/ano
    ...
    public static void main(String[] args){
        ...
        while (true){ 
            ...
            novoFilme.imprimir(); //Método para imprimir os atributos do objeto
