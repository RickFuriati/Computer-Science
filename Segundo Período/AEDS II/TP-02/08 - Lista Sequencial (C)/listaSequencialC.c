...
int main(void){
    ...
    for(int aux=0;aux<num;aux++){
        ...
        //substr(operacao,0,2);
        //printf("%s\n",operacao);
        strcpy(nomeFilmeOP,substr(linha,3,strlen(linha)));
        //printf("%s\n",nomeFilmeOP);
        //substr(nomeFilmeOP,3,strlen(linha));
        ...
        if(linha[0]=='I'&&linha[1]=='I'){ 
            ...
            strcpy(posic,substr(linha,3,5));
            //printf("%i\n",atoi(posic));
            //substr(posic,3,5);
            strcpy(nomePosic,substr(linha,6,strlen(linha)));
            ler(&nomePosic,&filme);
            inserir(filme,atoi(posic));
