...
class filaCircularFlex {
    ...
    static class FilaCircular {
        ...
        /*public int getTam(){
            int tam=0;
            for(Celula i=primeiro; i!=null && i!=ultimo; i=i.prox ){
                tam++;
            }
        }*/

        public void inserir(Filme x) throws Exception{
            //int posicUltimo=getTam();
            ...
            soma+= x.getDuracao();
            contador++;
            mediaFloat=soma/contador;
            
            MyIO.println((int)Math.round(mediaFloat));
            ...
            try{
                ...
                while(linha!=null){ //Enquanto a linha nao for "null" (fim do arquivo) executa o código
                    ...
                    if(linha.contains("<span class=\"runtime")==true){ //Busca pela tag "runtime" que indica o local onde a duração do filme se encontra no HTML
                        ...
                        duracao=horas + minutos; //Transforma as horas para minutos e soma com a variável dos minutos: resulta na duração
    ...
    public static void main(String[] args) throws Exception{
        ...
        FilaCircular filaFilmes=new FilaCircular(5);
        ...
        for(int aux=0;aux<n;aux++){
            ...
            if(operacao.compareTo("I")==0){
                ...
                MyIO.println("(R) "+filaFilmes.remover().getNome());
            }
        }
        filaFilmes.mostrar();
    }
