...
CelulaDupla* novaCelulaDupla(Filme elemento) {
...
void quicksortRec(int esq, int dir) {
    ...
    while (i <= j) {
        comparacoes++;
        Filme filmeI=celulaI.elemento;
        Filme filmeJ=celulaJ.elemento;
        while (strcmp(filmeI.situacao,pivo.situacao)<0){
            i++;
            comparacoes++;
            //celulaI=*celulaI.prox;
        } 
        while (strcmp(filmeJ.situacao, pivo.situacao)>0){
            j--;
            comparacoes++;
            //celulaJ=*celulaJ.ant;
        } 
...
void quicksortRecDes(int esq, int dir) {
    ...
    while (i <= j) {
        ...
        Filme filmeI=celulaI.elemento;
        Filme filmeJ=celulaJ.elemento;
        while (strcmp(filmeI.nome,pivo.nome)<0){
            comparacoes++;
            i++;
            //celulaI=*celulaI.prox;
        } 
        while (strcmp(filmeJ.nome, pivo.nome)>0){
            comparacoes++;
            j--;
            //celulaJ=*celulaJ.ant;
        } 
...
int main(void){
   ...
   start();
    ...
    FILE *log;
    log=fopen("752959_quicksort2C.txt","w+");
