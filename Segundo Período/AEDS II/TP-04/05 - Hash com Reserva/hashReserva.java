...
class hashReserva {
    ...
    public static void main(String[] args) throws Exception{
        ...
        while (true){ 
            ...
            MyIO.println("=> "+chaveBusca);
            if(hashDireto.pesquisar(chaveBusca)==false){
                MyIO.println("NAO");
            }
        ...
        Arq.openWrite("752959_hashReserva.txt");
        Arq.println("752959\t"+(System.currentTimeMillis()-tempoIni)+" ms\t"+ hashDireto.comparacoes); 
        Arq.close();  
