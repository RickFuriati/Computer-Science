...
class hashIndireta {
    ...
    static public class Lista {
        ...
        public boolean pesquisar(Hash hash,String x,int pos) {
            boolean retorno = false;
            for (Celula i = primeiro.prox; i != null; i = i.prox) {
             if(i.elemento.getTituloOriginal().compareTo(x) == 0){
                hash.setComparacoes((hash.getComparacoes()+1));
    ...
    static public class Hash {
        ...
        public boolean pesquisar(String elemento) {
            ...
            int pos=h(elemento);    
            return tabela[pos].pesquisar(this,elemento,h(elemento));
        }
        
        int getComparacoes(){
            int comp=this.comparacoes;
            return comp;
        }
        void setComparacoes(int comp){
    ...
    public static void main(String[] args) throws Exception{
        ...
        while (true){ 
            ...
            MyIO.println("=> "+chaveBusca);
            if(rIndireta.pesquisar(chaveBusca)==false){
                MyIO.println("NAO");
            }
        ...
        Arq.openWrite("752959_hashIndireta.txt");
        Arq.println("752959\t"+(System.currentTimeMillis()-tempoIni)+" ms\t"+ rIndireta.comparacoes); 
        Arq.close();  
