class mostraBST {
    ...
    public static void main(String[] args) throws Exception{
       String numCasos=MyIO.readLine();
       numCasos=numCasos.trim();
       int casos=Integer.parseInt(numCasos);

       for(int aux=0;aux<casos;aux++){
            ArvoreBinaria BST=new ArvoreBinaria();
            String numNos=MyIO.readLine().trim();
            int numeroNos=Integer.parseInt(numNos);

            String nos=MyIO.readLine();
            String[] vetorNos=nos.split(" ");
            for(int i=0;i<numeroNos;i++){
                int intAux=Integer.parseInt(vetorNos[i]);
                BST.inserir(intAux);
            }

            MyIO.println("Case "+(aux+1)+":");
            MyIO.print("Pre.: ");
            BST.caminharPre();
            MyIO.println("");
            MyIO.print("In..: ");
